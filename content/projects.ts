...
export const projects: Project[] = [
  ...
  },
  {
    ...
    headline: {
      en: "A second team, competing in the same category",
      tr: "Aynı kategoride yarışan ikinci takım",
    },
    summary: {
      en: "Captaining a four-person team that competes independently in the same TEKNOFEST category as LAÇİN. Running two teams against each other means keeping the organisation, task split and milestone planning genuinely separate while staying technically coherent across both.",
      tr: "LAÇİN ile aynı TEKNOFEST kategorisinde bağımsız yarışan dört kişilik takımın kaptanıyım. Birbiriyle yarışan iki takımı birlikte yürütmek, organizasyonu, görev dağılımını ve kilometre taşı planlamasını gerçekten ayrı tutarken teknik tutarlılığı iki tarafta da korumayı gerektiriyor.",
    },
    work: {
      en: [
        "Running two competing teams in parallel without leaking work between them",
        "Cross-team technical alignment and milestone synchronisation",
        "Task distribution and delivery planning",
      ],
      tr: [
        "Yarışan iki takımı, aralarında iş sızdırmadan paralel yürütmek",
        "Takımlar arası teknik hizalama ve kilometre taşı senkronizasyonu",
        "Görev dağılımı ve teslim planlaması",
      ],
    },
