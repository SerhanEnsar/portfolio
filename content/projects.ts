...
/**
 * The catalogue, newest work first. Nothing reads this directly — `projects`
 * below is the ordered view, and it is what every page, the console and
 * `generateStaticParams` see.
 *
 * `years` only resolves to a year and six of these are 2026, so the real
 * chronology inside a year lives here, in the order the entries are written.
 */
