...
export const roles: Role[] = [
  ...
  },
  {
    ...
    points: {
      en: [
        "LAÇİN and TUYGUN — AI for aviation: airborne detection and GPS-denied visual odometry",
      ...
      tr: [
        "LAÇİN ve TUYGUN — havacılıkta yapay zekâ: havadan tespit ve GPS'siz görsel odometri",
